 ...
 */
final class Version20220923140707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE detail (id INT NOT NULL, pizza_id INT NOT NULL, order_delivery_id INT NOT NULL, price DOUBLE PRECISION NOT NULL, size VARCHAR(2) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE ingredient_pizza (ingredient_id INT NOT NULL, pizza_id INT NOT NULL, PRIMARY KEY(ingredient_id, pizza_id))');
        $this->addSql('CREATE INDEX IDX_D6EFE5AE933FE08C ON ingredient_pizza (ingredient_id)');
        ...
        $this->addSql('ALTER TABLE ingredient_pizza ADD CONSTRAINT FK_D6EFE5AE933FE08C FOREIGN KEY (ingredient_id) REFERENCES ingredient (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE ingredient_pizza ADD CONSTRAINT FK_D6EFE5AED41D1D42 FOREIGN KEY (pizza_id) REFERENCES pizza (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredient_pizza DROP CONSTRAINT FK_D6EFE5AE933FE08C');
        ...
        $this->addSql('ALTER TABLE ingredient_pizza DROP CONSTRAINT FK_D6EFE5AED41D1D42');
